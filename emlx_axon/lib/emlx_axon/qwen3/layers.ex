defmodule EMLXAxon.Qwen3.Layers do
  ...
  RoPE is no longer computed here. `Attention.forward/12` delegates to
  `EMLXAxon.Qwen3.Native`, whose Qwen3 plugin callbacks transpose to
  `{B, N, T, D}` and apply RoPE internally via `mlx::core::fast::rope` (see
  `qwen3_plugin.cpp`).
  """
