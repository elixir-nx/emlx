...
defmodule EMLXAxon.PluginMetadataTest do
  ...
  test "loader rejects incompatible descriptors before publication" do
    ...
    fixtures = [
      ...
      {"null_callbacks", :null_callbacks, "null_callbacks", "callback table pointer is null"},
      ...
      {"null_callback", :null_callback, "null_callback", "callback function pointer is null"},
      ...
      {"bad_output_policy", :bad_output_policy, "bad_output_policy", "output policy is invalid"},
